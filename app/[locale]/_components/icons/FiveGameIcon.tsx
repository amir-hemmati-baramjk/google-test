...
// 5 Game Icon
export const FiveGameIcon: React.FC<IconProps> = ({ size = 24, className }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <g transform="translate(3 4)">
        <path
          d="M9.444.684,11,5.456h5.018a.99.99,0,0,1,.582,1.792L12.535,10.2l1.55,4.772a.99.99,0,0,1-1.524,1.107L8.5,13.128,4.443,16.077A.99.99,0,0,1,2.919,14.97L4.469,10.2.41,7.248A.99.99,0,0,1,.992,5.456H6.01L7.56.684a.99.99,0,0,1,1.884,0"
          fill="currentColor"
        />
      </g>
    </svg>
